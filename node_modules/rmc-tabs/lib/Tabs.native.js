        ...
        _this.renderContent = function () {
            ...
            return _react2['default'].createElement(
                ...
                tabs.map(function (tab, index) {
                    ...
                    return _react2['default'].createElement(
                        _TabPane.TabPane,
                        { key: key, shouldUpdate: _this.shouldUpdateTab(index), active: currentTab === index, style: { width: containerWidth } },
                        _this.shouldRenderTab(index) && _this.getSubElement(tab, index, getSubElements)
                    );
                })
            );
        };
